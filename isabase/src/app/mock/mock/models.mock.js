(function () {
    ...
    angular.module('isa-mock')
        .factory('modelsMock', Mock);

    /* @ngInject */
    function Mock(resourceMock, mockUtil, recordsMock, RESOURCE_URL, MODELS) {

        var url = mockUtil.url(RESOURCE_URL.models)
            , data = mockUtil.array(MODELS)
        ...
        mock.indexRoute.addPostProc(function (data, request) {
            ...
            angular.forEach(data, function (model, i) {
                if (appName == model.appName) {
                    ...
                    var count = 0;
                    angular.forEach(recordsMock.dataSource, function (record, i2) {
